...
<figure class="example-figure fragment" data-fragment-index="1">
  <img src="assets/alz71395-fig-0002.jpg"
       alt="Bar chart of dementia research publications in Latin America by topic, with clinical scenarios (15%) and basic science (14%) leading.">
  <figcaption>
    Example output: text-mined publication-trend analysis of Latin
    American dementia research by topic
    (Vazquez-Guajardo et al., <em>Alz &amp; Dem</em> 2026).
  </figcaption>
</figure>
```
...
/* Inline example figure that appears below the summary-list as the
   final fragment on the "Why text-mining" slide. Constrains the image
   so it fits the 1280x800 viewport even when a bullet body is open. */
.reveal figure.example-figure {
  margin: 0.4em auto 0;
  text-align: center;
}
.reveal figure.example-figure img {
  max-width: 80%;
  max-height: 280px;
  height: auto;
  border-radius: 4px;
...
.reveal figure.example-figure figcaption {
  font-size: 0.55em;
  color: #5b6b80;
  margin-top: 0.35em;
  line-height: 1.3;
